...
class _bookdisplayState extends State<bookdisplay> {
  ...
  //THE LANGUAGE OF THE BOOK FUNCTION
  getlang() {
    try {
      setState(() {
  ...
  //THE DESCRIPTION OF THE BOOK FUNCTION
  void getdesc() {
    try {
      setState(() {
  ...
  //THE TOTAL PAGES OF THE BOOK FUNCTION
  void getpagecount() {
    try {
      setState(() {
  ...
  //THE RATING OF THE BOOK FUNCTION
  void getrating() {
    try {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return (Scaffold(
      backgroundColor: Color(0xFFDFBB9D),////////COLORRRRR
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.lato(
                              textStyle: TextStyle(
                                  color: Colors.white,fontWeight: FontWeight.w500, fontSize: 16.5)),
                        ),
                        SizedBox(
                          height: 20,
                        ),
